...
INSERT INTO HOTEL(NOMBRE, DESTINO, CAPACIDAD, OCUPACION, ESTADO) VALUES ('Melia-Madrid-Princesa','Madrid',274,272,1);
INSERT INTO HOTEL(NOMBRE, DESTINO, CAPACIDAD, OCUPACION, ESTADO) VALUES ('Gran-Melia-Palacio-de-los-Duques','Madrid',180,89,1);
INSERT INTO HOTEL(NOMBRE, DESTINO, CAPACIDAD, OCUPACION, ESTADO) VALUES ('Melia-White-House','Londres',581,580,1);
...
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100000,'68060671Z','Melia-Madrid-Princesa','Madrid','Suite',2,1,'2022-05-17','2022-05-25');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100001,'35980493Y','Gran-Melia-Palacio-de-los-Duques','Madrid','Supremme',2,1,'2022-05-17','2022-05-29');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100002,'74575576P','Melia-White-House','Londres','Premium-King',4,2,'2022-05-17','2022-05-29');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100003,'73010655F','ME-London','Londres','Chic-Penthouse-Suite',5,2,'2022-05-25','2022-05-20');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100004,'38421952S','Innside-Paris-Charles-de-Gaulle','Paris','Loft',4,1,'2022-05-17','2022-05-31');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100005,'56808995F','Melia-Paris-La-Defense','Paris','Grand-Suite-Eiffel',3,1,'2022-05-17','2022-05-25');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100006,'86104585Z','TRYP-New-York-Times-Square','Nueva-York','Queen',5,1,'2022-05-17','2022-05-20');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (100007,'87504295J','Innside-New-York-Nomad','Nueva-York','Studio',3,2,'2022-05-17','2022-05-29');
