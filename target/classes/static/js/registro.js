    ...
    try {
        ...
        .then(data1 => {
            ...
            if(data1.result == "OK") {
                ...
                alert("Credenciales erróneos o no reconocidos. Por favor, revise sus credenciales. Debe introducir un NIF vigente, un email válido y una contraseña alfanúmerica de 10 a 50 caracteres. Recuerde que la contraseña debe ser igual en los dos campos.");
            }
       });
    } catch (err) {
