...
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (1,'68060671Z','Melia-Madrid-Princesa','Madrid','Suite',2,1,'2022-05-17','2022-05-25');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (2,'35980493Y','Gran-Melia-Palacio-de-los-Duques','Madrid','Supremme',2,1,'2022-05-17','2022-05-29');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (3,'74575576P','Melia-White-House','Londres','Premium-King',4,2,'2022-05-17','2022-05-29');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (4,'73010655F','ME-London','Londres','Chic-Penthouse-Suite',5,2,'2022-05-25','2022-05-20');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (5,'38421952S','Innside-Paris-Charles-de-Gaulle','Paris','Loft',4,1,'2022-05-17','2022-05-31');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (6,'56808995F','Melia-Paris-La-Defense','Paris','Grand-Suite-Eiffel',3,1,'2022-05-17','2022-05-25');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (7,'86104585Z','TRYP-New-York-Times-Square','Nueva-York','Queen',5,1,'2022-05-17','2022-05-20');
INSERT INTO RESERVA(ID, NIF, HOTEL, DESTINO, TIPO, HUESPEDES, HABITACIONES, FECHAENTRADA, FECHASALIDA) VALUES (8,'87504295J','Innside-New-York-Nomad','Nueva-York','Studio',3,2,'2022-05-17','2022-05-29');
